				...
				<div class="col-md-4 contact-grid-agile-w3">
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:info@example.com">duongquochao090696@gmail.com.com</a></p>
						</div>
					</div>
						...
						<h4> Thông Tin Liên Hệ</h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Điện Thoại </p><span>0967051501</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:info@example.com">duongquochao090696@gmail.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Địa Chỉ</p><span>Thành Phố Hồ Chí Minh</span>
								</div>
								<div class="clearfix"> </div>
							</div>
